...
import {personalData, updateAuthData} from '../../../Redux/action';
...
const UpdateTemporaryPrDp = ({navigation, route}) => {
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          <View style={{paddingHorizontal: 10}}>
            <MainTitle
              back={true}
              boldTitle={true}
              toptitle={localization?.UpdateTemporary?.header}
              subTitleStyle={{marginTop: 16}}
              subTitle={localization?.UpdateTemporary?.sub_header}
            />
            <WarningComponent
...
export default UpdateTemporaryPrDp;
